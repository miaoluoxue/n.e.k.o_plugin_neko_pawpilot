...
FACT_TEMPLATES = {
    ...
    "trip_progress": "太好啦！我们已经走了{mark_ratio}了喵，距离目的地还有 {km:.0f} km~",
    "distance_mark": "快到啦！还剩 {km:.0f} km 就到目的地了（{mark} km 预告）",
...
SHORT_LINES = {
    ...
    "game_end": ["今天辛苦了喵，晚安~ 💤"],
    "trip_progress": ["已经走了{mark_ratio}了喵！还剩 {km:.0f} km~"],
    "distance_mark": ["快到了喵！还剩 {km:.0f} km~"],
